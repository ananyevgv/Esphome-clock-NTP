...
Дисплейный модуль построен на двух TM1637 т.к. в часах стоят 7-ми сегментные индикаторы с общим анодом (MAX7218 общий катод). Для подключения индикатора влажности используется незадействованный 5 и 6 сегмент TM1637. Значок влажности подключен 6 сегменту и DP 2-го TM1637
...
Дисплейный модуль построен на трех TM1637 т.к. в часах стоят 7-ми сегментные индикаторы с общим анодом (MAX7218 общий катод). Значок влажности подключен к 3 сегменту и DP 3-го TM1637. 
