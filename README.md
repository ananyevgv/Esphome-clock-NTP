...
> Избавляемся от множества отдельных датчиков — все функции объединены в настольных часах.

Китайские готовые часы часто имеют дисплеи, установленные "вверх ногами".
